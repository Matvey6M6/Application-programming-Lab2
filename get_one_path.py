...
def get_next(mark: int, id: int) -> str:
    ...
    """
    return  os.path.join( 'application_programming_first_lab_and_dataset','dataset') + f'\\{mark}'+f'\\{id:04}.txt'


if __name__ == "__main__":
    mark = 4
    path_to_dataset =  path_to_dataset = os.path.join( 'application_programming_first_lab_and_dataset','dataset')
